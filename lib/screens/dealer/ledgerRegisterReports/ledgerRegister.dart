...
class DealerRegisterReportScreen extends StatefulWidget {
  @override
  _DealerRegisterReportScreenState createState() =>
      _DealerRegisterReportScreenState();
}

class _DealerRegisterReportScreenState
    extends State<DealerRegisterReportScreen> {
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (invoice['billDate'] != null) {
                        formattedDate = formatDate(invoice['billDate']);
                      }
