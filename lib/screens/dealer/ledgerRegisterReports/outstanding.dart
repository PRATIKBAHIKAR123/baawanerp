...
class DealerOutstandingReportScreen extends StatefulWidget {
  @override
  _DealerOutstandingReportScreenState createState() =>
      _DealerOutstandingReportScreenState();
}

class _DealerOutstandingReportScreenState
    extends State<DealerOutstandingReportScreen> {
      ...
      case '1':
        {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => DealerOutstandingReportScreen()),
          );
        }
        break;
      case '2':
