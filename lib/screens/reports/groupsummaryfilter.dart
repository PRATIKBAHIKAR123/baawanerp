...
class GroupSummaryFilterPopup extends StatefulWidget {
  final Function(
    String,
    String,
    bool,
  ...
  @override
  _GroupSummaryFilterPopupState createState() =>
      _GroupSummaryFilterPopupState();
}

class _GroupSummaryFilterPopupState extends State<GroupSummaryFilterPopup> {
