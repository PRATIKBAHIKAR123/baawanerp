...
class ageFilterPopup extends StatefulWidget {
  final Function(String, String) onSubmit; // Define callback function

  ageFilterPopup({required this.onSubmit});

  @override
  _ageFilterPopupState createState() => _ageFilterPopupState();
}

class _ageFilterPopupState extends State<ageFilterPopup> {
