...
class CreditNoteVoucherScreen extends StatefulWidget {
  final VoucherType voucherType;

  const CreditNoteVoucherScreen({super.key, required this.voucherType});
  @override
  State<CreditNoteVoucherScreen> createState() =>
      _CreditNoteVoucherScreenState();
}

class _CreditNoteVoucherScreenState extends State<CreditNoteVoucherScreen> {
